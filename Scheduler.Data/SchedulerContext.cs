...
namespace Scheduler.Data
{
    public class SchedulerContext : DbContext
    {
        ...
        public DbSet<UserLight> UserLights { get; set; }
        public DbSet<ScheduleLight> ScheduleLights { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BusinessSchedule>();
           // modelBuilder.Entity<UserLight>();
            modelBuilder.Entity<ScheduleLight>();
            modelBuilder.Entity<UserSchedule>().ToTable("UserSchedule"); 
